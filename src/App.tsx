...
// Imagens Workshop - Do Topo ao Próximo Ciclo (2 imagens)
import imgWorkshop from "figma:asset/ba5819ef27eb4672cb37709313675fe72661e7ad.png";
import imgWorkshop1 from "figma:asset/f6d349d24dd0e898a4052f62059589f943602f9c.png";
  ...
  return (
    <div className="min-h-screen bg-[#F1F1F1] flex flex-col items-center pt-12 pb-24 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-[672px] flex flex-col gap-8">
        ...
        {/* 6. Banner: Workshop Do Topo ao Próximo Ciclo */}
        <a
